...
export default new Vuex.Store({
	...
	// http://localhost:8080/#/pages/user-chat/user-chat?user=%7B%22user_id%22%3A%22401%22,%22username%22%3A%2219911214910%22,%22userpic%22%3A%22http%3A%2F%2Fchat.cloud-cc.top%2Fuploads%2F20221017%2F76ca922931acf62f8633f0f0931af359.jpg%22%7D
	actions:{
		// 初始化登录状态
		initUser({state,dispatch}){
			...
			if(user){
				...
				if (state.user.userpic) {
					state.user.userpic = $C.host + state.user.userpic
				}
				// 打开socket
				dispatch('openSocket')
			}
